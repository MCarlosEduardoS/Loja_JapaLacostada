...
LOAD DATA INFILE 'D:\Users\DESENVOLVIMENTO\Desktop\Prova\db\clientes.csv'
INTO TABLE clientes
...
LOAD DATA INFILE 'D:\Users\DESENVOLVIMENTO\Desktop\Prova\db\filmes.csv'
INTO TABLE filmes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '/r/n'
...
LOAD DATA INFILE 'D:\Users\DESENVOLVIMENTO\Desktop\Prova\db\locacoes.csv'
INTO TABLE locacoes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '/r/n'
